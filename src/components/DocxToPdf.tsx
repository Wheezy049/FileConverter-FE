...
function DocxToPdf() {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const acceptedFormats = ["application/vnd.openxmlformats-officedocument.wordprocessingml.document"];
        ...
        if (selectedFile && acceptedFormats.includes(selectedFile.type)) {
            ...
            setFile(null);
            setIsComplete(false);
            setErrMsg("Please upload a valid Docx file.");
        }
    };
    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await apiFetch("/api/v1/convert/docx-to-pdf", {
                method: "POST",
                body: formData,
            });
                                    ...
                                    <div onDragOver={handleDragOver} onDrop={handleDrop}>
                                        ...
                                        >
                                            ...
                                            <p className="text-[16px] md:text-[20px] text-[#475467] pt-3">
                                                <span className="text-[#4A90E2] font-medium">Upload</span> or drag & drop your DOCX file here.
                                            </p>
                                            <span className="block text-[#71717A] text-sm md:text-base">
                                                Maximum file size: 100MB (DOCX only)
                                            </span>
