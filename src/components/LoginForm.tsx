            ...
            <div className="mt-3 w-full">
              <div className="flex w-full justify-between mt-3 mb-6">
                <span className="cursor-pointer font-medium opacity-80 hover:opacity-100 transition-opacity duration-150 ease-in-out">
                  ...
                  <span className="ml-2 text-[1rem] leading-6 text-[#525252]">
                    Remember me
                  </span>
                </span>
                <Link
                  href="/forgot-password"
                  className="text-[#0A0A0A] hover:text-[#3A78BA] text-[1rem] leading-6 opacity-80 hover:opacity-100 transition-opacity duration-150 ease-in-out"
                >
                  Forgot Password ?
                </Link>
              </div>
              <button className="w-full flex justify-center items-center bg-[#4A90E2] text-white py-2 rounded hover:bg-[#3A78BA] hover:opacity-95">Login</button>
              ...
              <div className="w-fit flex flex-col mx-auto md:flex-row items-center gap-1 text-nowrap text-[#525252] mt-4">
                <ShieldCheck />
                <span className="text-[0.75rem] leading-4">
                  By logging in you agree to the
                </span>
                <div>
                  <Link
                    href="/terms"
                    className="text-[#4A90E2] text-[0.8125rem] leading-[15.6px] font-semibold"
                  >
                    Terms of Service
                  </Link>{" "}
                  <span className="text-[0.75rem] leading-4">and</span>
                  <Link
                    href="/privacy-policy"
                    className="text-[#4A90E2] text-[0.8125rem] leading-[15.6px] font-semibold ml-1"
                  >
                    Privacy Policy
                  </Link>
                </div>
