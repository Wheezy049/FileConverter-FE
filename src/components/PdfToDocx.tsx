...
function PdfToDocx() {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (selectedFile && acceptedFormats.includes(selectedFile.type)) {
            ...
            setFile(null);
            setIsComplete(false);
            setErrMsg("Please upload a valid PDF file.");
        }
    };
    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await apiFetch("/api/v1/convert/pdf-to-docx", {
                method: "POST",
                body: formData,
            });
                                    ...
                                    <div onDragOver={handleDragOver} onDrop={handleDrop}>
                                        ...
                                        >
                                            ...
                                            <p className="text-[16px] md:text-[20px] text-[#475467] pt-3">
                                                <span className="text-[#4A90E2] font-medium">Upload</span> or drag & drop your PDF file here.
                                            </p>
